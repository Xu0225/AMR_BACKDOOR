...
from tensorflow.keras.layers import Input,Dense,Conv1D,MaxPool1D,ReLU,Dropout,Softmax,concatenate,Reshape,GaussianDropout
# from keras.layers.convolutional import Conv2D
from tensorflow.keras.layers import Conv2D, MaxPool2D
from tensorflow.python.keras.layers import CuDNNLSTM,Lambda,Multiply,Add,Subtract,MaxPool2D,GRU,LeakyReLU,BatchNormalization
import tensorflow as tf
