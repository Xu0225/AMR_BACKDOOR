...
from tensorflow.keras.layers import Input,Dense,Conv1D,MaxPool1D,ReLU,Dropout,Softmax,concatenate,Conv2D,LSTM
from tensorflow.keras.layers import LSTM,Permute,Reshape,ZeroPadding2D,Activation




def CLDNNLikeModel1(weights=None,
             input_shape1=[2,128],
             classes=11,
             **kwargs):
    ...
    layer_dense2 = Dense(11, kernel_initializer='he_normal', name="dense2")(layer_dropout)
