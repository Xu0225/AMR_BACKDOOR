...
def concate_feat(X_train_seq,X_test_seq,X_train_img,X_test_img):
    intermediate_output_seq_train, intermediate_output_seq_test = \
        get_intermediate_train_test(X_train_seq,X_test_seq,pos_model_path='D:/zhaixu/Thesis_Code/CNN2_EPOCH_100.h5',layer_name='flatten_2')

    intermediate_output_img_train, intermediate_output_img_test = \
        get_intermediate_train_test(X_train_img,X_test_img,pos_model_path='D:/zhaixu/Thesis_Code/VGG16_benign.h5',layer_name='dense_5')
...
def main():
    ...
    #print(concate_feature_train.shape)
    ...
    # model, history = train(model, x_train, y_train, x_val, y_val, nb_epoch=100, batch_size=1024)
    #
    # # ASR
    # print('ASR')
